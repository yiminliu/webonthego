...
import com.tscp.util.logger.Slf4jLogger;
...
public class LoggingAspect {
	...
	@AfterThrowing(value = "@annotation(com.tscp.util.logger.aspect.Loggable)", throwing = "throwable", argNames = "joinPoint, throwable")
